 ...
 * @author 焕晨HChen
 */
public final class ScreenMonitorInterception {
    private static final String TAG = "ScreenMonitorInterception";

    public static void blockScreenOffLyric(@NonNull String... excludes) {
        try {
