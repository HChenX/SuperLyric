...
public final class Apple extends AbsPublisher {
    ...
    private static class LyricsLine {
        ...
        public boolean equals(Object o) {
            if (!(o instanceof LyricsLine that)) return false;
            return start == that.start && end == that.end && Objects.equals(lyric, that.lyric) &&
                Objects.equals(translation, that.translation) && Objects.deepEquals(words, that.words);
        }

        @Override
        public int hashCode() {
            return Objects.hash(start, end, lyric, translation, Arrays.hashCode(words));
        }
    }
